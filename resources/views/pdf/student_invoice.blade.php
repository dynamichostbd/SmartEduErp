        ...
        <div class="invoice">
            ...
            <div class="box mt-3">
                <div class="col-9 student-info">
                    <b>Name :</b> {{ $invoice->student->name ?? '' }} <br />
                    <b>Mobile :</b> {{ $invoice->student->mobile ?? '' }} <br />
                    <b>Student ID :</b> {{ $invoice->student->student_id ?? '' }} <br />
                    <b>Admission ID :</b> {{ $invoice->admission_id ?? ($invoice->student->admission_id ?? '') }} <br />
                    <b>College Roll :</b> {{ $invoice->college_roll ?? ($invoice->student->college_roll ?? '') }} <br />
                    <b>Reg. No :</b> {{ $invoice->reg_no ?? ($invoice->student->reg_no ?? '') }}
                </div>
