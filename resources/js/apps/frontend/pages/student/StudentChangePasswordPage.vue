                    ...
                    <div class="rounded-sm border border-slate-300 bg-white">
                        ...
                        <div class="p-4">
                            <div v-if="error"
                                ...
                                error }}</div>
                            <div v-if="success"
                                class="mb-4 rounded-sm border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-800">
                                {{ success }}</div>
                            ...
                            <form class="mx-auto w-full max-w-2xl" @submit.prevent="submit">
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="grid grid-cols-1 items-center gap-2 sm:grid-cols-3">
                                        <div class="text-sm font-semibold text-slate-700">Old Password <span
                                        ...
                                        <div class="sm:col-span-2">
                                            <input v-model="form.old_password" type="password"
                                                ...
                                                placeholder="Old Password" @blur="checkOld" required />
                                            <div v-if="oldChecked && !oldOk"
                                                class="mt-1 text-xs font-semibold text-red-600">Old password do not
                                                match our records!!</div>
                                        </div>
                                    </div>

                                    <div class="grid grid-cols-1 items-center gap-2 sm:grid-cols-3">
                                        <div class="text-sm font-semibold text-slate-700">New Password <span
                                                class="text-red-600">*</span></div>
                                        <div class="sm:col-span-2">
                                    ...
                                    <div class="grid grid-cols-1 items-center gap-2 sm:grid-cols-3">
                                        <div class="text-sm font-semibold text-slate-700">Confirm Password <span
                                                class="text-red-600">*</span></div>
                                        <div class="sm:col-span-2">
