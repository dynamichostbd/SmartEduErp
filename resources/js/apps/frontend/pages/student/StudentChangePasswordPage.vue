            ...
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                ...
                <div class="lg:col-span-9">
                    <div class="rounded-sm border border-slate-300 bg-white">
                        <div class="border-b border-slate-300 bg-slate-50 px-4 py-3 text-sm font-extrabold text-slate-800">CHANGE PASSWORD</div>
                        <div class="p-4">
                            <div v-if="error" class="mb-4 rounded-sm border border-red-200 bg-red-50 p-3 text-sm text-red-800">{{ error }}</div>
                            <div v-if="success" class="mb-4 rounded-sm border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-800">{{ success }}</div>
                                ...
                                <div class="grid grid-cols-1 gap-4">
                                    <div class="grid grid-cols-1 items-center gap-2 sm:grid-cols-3">
                                        ...
                                        <div class="sm:col-span-2">
                                            <input v-model="form.old_password" type="password" class="h-10 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm outline-none" placeholder="Old Password" @blur="checkOld" required />
                                    ...
                                    <div class="grid grid-cols-1 items-center gap-2 sm:grid-cols-3">
                                        ...
                                        <div class="sm:col-span-2">
                                            <input v-model="form.new_password" type="password" class="h-10 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm outline-none" placeholder="New Password" required />
                                        </div>
                                    </div>
                                    ...
                                    <div class="grid grid-cols-1 items-center gap-2 sm:grid-cols-3">
                                        ...
                                        <div class="sm:col-span-2">
                                            <input v-model="form.confirm_password" type="password" class="h-10 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm outline-none" placeholder="Confirm Password" required />
                                        </div>
                                    </div>
                                </div>
