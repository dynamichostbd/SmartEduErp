        ...
        <div class="mx-auto w-full max-w-6xl">
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                ...
                <div class="lg:col-span-9">
                    <div class="flex flex-wrap items-center justify-between gap-3 rounded-md border border-slate-200 bg-slate-50 px-4 py-3">
                    ...
                    <div v-if="studentProfileSaveError" class="mt-4 rounded-md border border-red-200 bg-red-50 p-3 text-sm text-red-800">{{ studentProfileSaveError }}</div>
                    <div v-if="studentProfileSaveSuccess" class="mt-4 rounded-md border border-emerald-200 bg-emerald-50 p-3 text-sm text-emerald-800">{{ studentProfileSaveSuccess }}</div>
                    ...
                    <form class="mt-4" @submit.prevent="submitStudentProfileUpdate">
                        <div class="grid grid-cols-1 gap-4 lg:grid-cols-3">
                            <div>
                                ...
                                <input v-model="studentProfileEditForm.name" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" required />
                                ...
                                <div class="mt-4">
                                    ...
                                    <select v-model="studentProfileEditForm.blood_group" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10">
                                ...
                                <div class="mt-4">
                                    ...
                                    <input v-model="studentProfileEditForm.dob" type="date" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Religion</label>
                                    <select v-model="studentProfileEditForm.religion" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10">
                                        <option value="">--Select One--</option>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input v-model="studentProfileEditForm.nid" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Father's Name</label>
                                    <input v-model="studentProfileEditForm.fathers_name" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>
                            </div>

                            <div>
                                <label class="text-sm font-bold text-slate-700">Registration No</label>
                                <input v-model="studentProfileEditForm.reg_no" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">SSC GPA</label>
                                    <input v-model="studentProfileEditForm.ssc_gpa" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Hostel</label>
                                    <select v-model="studentProfileEditForm.hostel_id" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10">
                                        <option value="">--Select One--</option>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input v-model="studentProfileEditForm.hostel_room_no" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input v-model="studentProfileEditForm.guardian_name" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-slate-50 px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Guardian Mobile</label>
                                    <input v-model="studentProfileEditForm.guardian_mobile" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Guardian Relations</label>
                                    <input v-model="studentProfileEditForm.guardian_relations" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>
                            </div>

                            <div>
                                <label class="text-sm font-bold text-slate-700">Email</label>
                                <input v-model="studentProfileEditForm.email" type="email" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Present Address</label>
                                    <textarea v-model="studentProfileEditForm.address" rows="4" class="mt-1 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10"></textarea>
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Permanent Address</label>
                                    <textarea v-model="studentProfileEditForm.permanent_address" rows="4" class="mt-1 w-full rounded-md border border-slate-200 bg-white px-3 py-2 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10"></textarea>
                                </div>
                                ...
                                <div class="mt-4">
                                    ...
                                    <input v-model="studentProfileEditForm.passing_year" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Nationality</label>
                                    <input v-model="studentProfileEditForm.nationality" type="text" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10" />
                                </div>

                                <div class="mt-4">
                                    <label class="text-sm font-bold text-slate-700">Extra Curricular Activity</label>
                                    <select v-model="studentProfileEditForm.extra_curricular_activity" class="mt-1 h-10 w-full rounded-md border border-slate-200 bg-white px-3 text-sm outline-none focus:border-emerald-600 focus:ring-2 focus:ring-emerald-600/10">
                                        <option value="">--Select One--</option>
                        ...
                        <div class="mt-5 flex items-center justify-end gap-3">
                            <button type="button" class="rounded-md border border-slate-200 bg-white px-6 py-2.5 text-sm font-extrabold text-slate-700 hover:bg-slate-50" @click="go('/student/profile')">Cancel</button>
                            <button type="submit" class="rounded-md bg-emerald-600 px-8 py-2.5 text-sm font-extrabold text-white hover:bg-emerald-700" :disabled="studentProfileSaving">{{ studentProfileSaving ? 'Saving...' : 'Save Changes' }}</button>
                        </div>
                    </form>
                </div>
            </div>
