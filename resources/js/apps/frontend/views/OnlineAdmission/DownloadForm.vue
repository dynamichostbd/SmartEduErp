        ...
        <div v-else class="flex flex-col md:flex-row min-h-[400px]">
            ...
            <div class="w-full md:w-2/5 bg-[#f8fafc] p-8 sm:p-12 flex flex-col items-center justify-center relative overflow-hidden border-b md:border-b-0 md:border-r border-slate-200">
                ...
                <div class="mb-8 relative z-10">
                    <svg width="140" height="140" viewBox="0 0 120 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <!-- Clipboard -->
                        <rect x="35" y="30" width="50" height="65" rx="6" fill="#ffffff" stroke="#0d6b75" stroke-width="4"/>
                        <path d="M45 25 C45 22.2386 47.2386 20 50 20 H70 C72.7614 20 75 22.2386 75 25 V30 H45 V25 Z" fill="#0d6b75"/>
                        <line x1="45" y1="45" x2="75" y2="45" stroke="#e2e8f0" stroke-width="3" stroke-linecap="round"/>
                        <line x1="45" y1="55" x2="65" y2="55" stroke="#e2e8f0" stroke-width="3" stroke-linecap="round"/>
                        <!-- Download Icon Bubble -->
                        <circle cx="60" cy="70" r="14" fill="#0d6b75"/>
                        <path d="M60 63 V75 M55 70 L60 75 L65 70" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                        <line x1="55" y1="79" x2="65" y2="79" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/>
                    </svg>
                </div>
                ...
                <h2 class="text-3xl font-extrabold text-slate-800 mb-4 z-10 text-center tracking-tight">
                    Download <br />
                    <span class="bg-gradient-to-r from-[#0d6b75] to-[#20a3b2] bg-clip-text text-transparent">Admission Form</span>
                </h2>
            ...
            <div class="w-full md:w-3/5 p-8 sm:p-10 relative flex flex-col justify-center">
                ...
                <div class="mt-12 sm:mt-6 mb-8 text-center flex flex-col items-center">
                    ...
                    <p class="text-sm text-slate-500 mt-2">Please provide the details below to access your admission form.</p>
                </div>
                ...
                <!-- Error Message -->
                <div v-if="app.onlineAdmissionDownloadError" class="mt-6 rounded-md border border-red-200 bg-red-50 p-4 text-sm text-red-800 flex items-start gap-3 shadow-sm">
                ...
                <div class="mt-6">
                    <template v-if="app.onlineAdmissionDownloadShow">
                        <template v-if="app.onlineAdmissionDownloadData">
                            <div class="rounded-xl border border-slate-200 bg-white p-6 shadow-sm relative overflow-hidden">
                                ...
                                <div class="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-[#0d6b75] to-[#12919e]"></div>

                                <div class="flex flex-col xl:flex-row xl:items-center justify-between gap-4 mb-6 pb-4 border-b border-slate-100">
                                    <div class="flex items-center gap-3">
                                        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-[#0d6b75]/10 text-[#0d6b75]">
                                    ...
                                    <div>
                                        ...
                                        <div v-else class="rounded-md bg-slate-100 px-4 py-2 text-sm font-bold text-slate-500 flex items-center justify-center gap-2 w-full xl:w-auto">
                                ...
                                <div class="grid grid-cols-1 sm:grid-cols-2 gap-y-4 gap-x-6 text-sm">
                                    <div class="flex flex-col border-b border-slate-50 pb-2 sm:border-none sm:pb-0">
                                        <span class="text-slate-400 text-xs font-medium uppercase tracking-wider mb-0.5">Admission Roll</span>
                                        <span class="font-bold text-slate-800">{{ app.onlineAdmissionDownloadData.admission_roll }}</span>
                                    </div>
                                    <div class="flex flex-col border-b border-slate-50 pb-2 sm:border-none sm:pb-0">
                                        <span class="text-slate-400 text-xs font-medium uppercase tracking-wider mb-0.5">Mobile</span>
                                        <span class="font-bold text-slate-800">{{ app.onlineAdmissionDownloadData.mobile }}</span>
                                    </div>
                                    <div class="flex flex-col border-b border-slate-50 pb-2 sm:border-none sm:pb-0">
                                        <span class="text-slate-400 text-xs font-medium uppercase tracking-wider mb-0.5">Fathers Name</span>
                                        <span class="font-bold text-slate-800">{{ app.onlineAdmissionDownloadData.fathers_name }}</span>
                                    </div>
                                    <div class="flex flex-col border-b border-slate-50 pb-2 sm:border-none sm:pb-0">
                                        <span class="text-slate-400 text-xs font-medium uppercase tracking-wider mb-0.5">Mothers Name</span>
                                        <span class="font-bold text-slate-800">{{ app.onlineAdmissionDownloadData.mothers_name }}</span>
                                    </div>
                                    <div class="flex flex-col sm:col-span-2">
                                        <span class="text-slate-400 text-xs font-medium uppercase tracking-wider mb-0.5">Address</span>
                                        <span class="font-bold text-slate-800">{{ app.onlineAdmissionDownloadData.address }}</span>
                                    </div>
                                </div>
                            </div>
                        </template>
                    ...
                    <div v-else
                        ...
                        <p class="text-center sm:text-left font-medium">Please input your admission roll and your mobile number for admission form.</p>
                    </div>
                </div>
