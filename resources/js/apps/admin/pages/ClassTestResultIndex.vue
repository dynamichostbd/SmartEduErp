                ...
                <table class="min-w-full divide-y divide-slate-200 text-sm">
                    <thead class="bg-slate-50">
                        <tr>
                            ...
                            <th class="px-3 py-2 text-left font-semibold text-slate-700">Exam Date</th>
                    ...
                    <tbody class="divide-y divide-slate-200 bg-white">
                        <tr v-for="row in rows" :key="'ctr-' + row.id">
                            ...
                            <td class="px-3 py-2 text-slate-800">{{ row.exam_date || '--' }}</td>
