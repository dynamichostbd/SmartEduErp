                ...
                <table class="min-w-full border-collapse border border-slate-200">
                    <thead class="bg-slate-50">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                            ...
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3">Qualification Name</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Registration</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Online Admission</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Check Application Fees</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Admission Roll Verify</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Subject Choose</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Migration</th>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(row, idx) in rows" v-else :key="row.id" class="text-sm text-slate-800" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.online_admission) }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.application_fees) }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.admission_roll_verify) }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.subject_choose) }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.migration) }}</td>
