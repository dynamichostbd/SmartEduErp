        ...
        <div class=" border border-slate-300 bg-white p-5">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    <button type="button" class="rounded-sm border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 hover:bg-slate-50" @click="goIndex">Admin List</button>
            ...
            <div class="lg:col-span-4">
                <div class=" border border-slate-300 bg-white p-5">
                    <div class="flex flex-col items-center text-center">
                        <img :src="previewProfile || admin?.profile || fallback" alt="Admin" class="h-28 w-28 rounded-full border border-slate-300 object-cover" />
                        <div class="mt-3">
                ...
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div v-if="tab === 'edit'" class="mt-4 grid grid-cols-1 gap-4 lg:grid-cols-12">
                        ...
                        <div class="lg:col-span-6">
                            ...
                            <input v-model="form.email" type="email" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100" :disabled="!canEditEmail" />
                        </div>
                        <div class="lg:col-span-6">
