        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="min-w-0">
                    ...
                    <div class="mt-1 text-sm text-slate-600">Upload and manage roll lists for online admission verification</div>
                </div>
        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-12">
                ...
                <div class="xl:col-span-2">
                    ...
                    <select v-model="filters.academic_class_id" class="mt-1 h-10 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm">
                        <option value="">All</option>
...
<script>
export default {
    name: 'OnlineAdmissionRollVerifyIndex',
    props: {
        systems: {
            type: Object,
            default: () => ({}),
    ...
    methods: {
        ...
        goCreate() {
            window.location.href = '/admin/onlineAdmissionRollVerify/create'
        },
        goView(id) {
            window.location.href = `/admin/onlineAdmissionRollVerify/${id}`
        },
        goPage(p) {
        ...
        async search(resetPage) {
            ...
            this.error = ''
            try {
                const res = await window.axios.get('/admin/onlineAdmissionRollVerify/list', { params: this.filters })
        ...
        async destroyRow(id) {
            ...
            this.error = ''
            try {
                await window.axios.delete(`/admin/onlineAdmissionRollVerify/${id}`)
                this.search(false)
            } catch (e) {
