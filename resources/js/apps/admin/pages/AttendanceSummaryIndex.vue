                ...
                <table class="min-w-full border-collapse border border-slate-300 text-sm">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-slate-700">From Date</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-slate-700">To Date</th>
                    ...
                    <tbody class="bg-white">
                        <tr v-for="(row, idx) in rows" :key="'s-' + row.id" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            <td class="border border-slate-300 px-1 py-1 text-slate-800">{{ row.from_date || '--' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-slate-800">{{ row.to_date || '--' }}</td>
                        ...
                        <tr v-if="!rows.length">
                            <td colspan="7" class="px-1 py-10 text-center text-slate-500">No data found</td>
                        </tr>
                    </tbody>
                </table>
            </div>
