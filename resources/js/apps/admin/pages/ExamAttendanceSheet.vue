<template>
    <div class="flex flex-col gap-4">
        ...
        <div class=" border border-slate-300 bg-white p-5">
            <form class="grid grid-cols-1 gap-4 lg:grid-cols-12" @submit.prevent="search()">
                ...
                <div class="lg:col-span-2 flex items-end">
                    <button
                        type="submit"
                        class="h-9 w-full rounded-sm bg-emerald-600 px-4 text-sm font-semibold text-white hover:bg-emerald-700"
                        :disabled="loading"
                    >
                        {{ loading ? '...' : 'Search' }}
                    </button>
        ...
        <div id="print-area" class=" border border-slate-300 bg-white p-5">
