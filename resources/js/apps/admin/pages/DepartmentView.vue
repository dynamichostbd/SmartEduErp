        ...
        <div class=" border border-slate-300 bg-white p-5">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <button type="button" class="rounded-sm bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800" :disabled="loading || !departmentId" @click="goEdit">Edit</button>
                </div>
            </div>
        </div>
            ...
            <div v-else class="grid grid-cols-1 gap-3 sm:grid-cols-2">
                ...
                <div class="rounded-xl border border-slate-300 p-4 sm:col-span-2">
                    ...
                    <div v-else class="mt-2 grid grid-cols-1 gap-2 sm:grid-cols-2">
                        <div v-for="m in maps" :key="'m-' + (m.id || m.academic_qualification_id)" class="rounded-sm border border-slate-300 bg-slate-50 p-3">
