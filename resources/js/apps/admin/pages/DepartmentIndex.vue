                ...
                <table class="min-w-[600px] w-full border-collapse border border-slate-300">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-slate-700">Department Name</th>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(row, idx) in rows" v-else :key="row.id" class="text-sm text-slate-800" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-300 px-1 py-1 text-slate-800">{{ row.description || '' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.registration_open ? 'Yes' : 'No' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.application_fee || '' }}</td>
