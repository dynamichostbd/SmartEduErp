                ...
                <table class="min-w-full border-collapse border border-slate-300">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Parent Menu</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Menu Name</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">Route Name</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">Params</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">Sorting</th>
                    ...
                    <tbody>
                        ...
                        >
                            ...
                            <td class="border border-slate-300 px-1 py-1">{{ row.parent_menu_name || '' }}</td>
                            <td class="border border-slate-300 px-1 py-1 font-medium text-slate-900">{{ row.menu_name || '' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.route_name || '' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.params || '' }}</td>
