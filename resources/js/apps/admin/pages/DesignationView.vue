    ...
    <div class="flex flex-col gap-4">
        <div class=" border border-slate-300 bg-white p-5">
            <div class="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
                <div class="min-w-0">
                    <div class="truncate text-xl font-semibold text-slate-900">Designation Details</div>
                </div>
                ...
                <div class="flex flex-wrap items-center gap-2">
                    ...
                    <button type="button" class="rounded-sm bg-slate-900 px-4 py-2 text-sm font-semibold text-white hover:bg-slate-800" :disabled="loading || !designationId" @click="goEdit">Edit</button>
                </div>
            </div>
        </div>
...
export default {
    ...
    methods: {
        ...
        goEdit() {
            this.go(`/admin/designation/${this.designationId}/edit`)
        },
        async load() {
            ...
            try {
                ...
                this.row = res?.data?.designation || res?.data || {}
            } catch (e) {
