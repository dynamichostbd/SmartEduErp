        ...
        <div class=" border border-slate-300 bg-white p-5">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                ...
                <div class="flex w-full flex-col gap-2 sm:w-auto sm:flex-row">
                    ...
                    <select v-model="filters.type" class="h-9 rounded-sm border border-slate-300 bg-white px-3 text-sm outline-none" :disabled="loading">
                ...
                <table class="min-w-full border-collapse border border-slate-300 text-sm">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-slate-700">English Name</th>
                    ...
                    <tbody class="bg-white">
                        ...
                        <tr v-for="(row, idx) in rows" v-else :key="row.id" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-300 px-1 py-1">{{ row.name_en || '—' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.type || '—' }}</td>
