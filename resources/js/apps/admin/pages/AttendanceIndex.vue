                ...
                <table class="min-w-full border-collapse border border-slate-300 text-sm">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center text-slate-700">Present</th>
                    ...
                    <tbody class="bg-white">
                        <tr v-for="(row, idx) in rows" :key="'a-' + row.id" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-300 px-1 py-1 text-center text-slate-800">{{ row.total_student ?? 0 }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center text-emerald-700">{{ row.present_student_count ?? 0 }}</td>
