                ...
                <table class="min-w-full border-collapse border border-slate-200">
                    <thead class="bg-slate-50">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-500">
                            ...
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3">Short Name</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Allocated Days</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Back Date</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Documents</th>
                            <th class="border border-slate-200 bg-slate-50 px-4 py-3 text-center">Reason</th>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(row, idx) in rows" v-else :key="row.id" class="text-sm text-slate-800" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-200 px-4 py-3">{{ row.short_name || '—' }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ row.allocated_leave_days ?? '—' }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.back_date_select) }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.documents_upload) }}</td>
                            <td class="border border-slate-200 px-4 py-3 text-center">{{ yesNo(row.reason) }}</td>
