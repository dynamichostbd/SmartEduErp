                ...
                <table class="min-w-full border-collapse border border-slate-300">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Holiday Type</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Holiday Name</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">From Date</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">To Date</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">Total Days</th>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(row, idx) in rows" v-else :key="row.id" class="text-sm text-slate-800" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-300 px-1 py-1">{{ row.holiday_type || '—' }}</td>
                            ...
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.from_date || '—' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.to_date || '—' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.total_days ?? '—' }}</td>
