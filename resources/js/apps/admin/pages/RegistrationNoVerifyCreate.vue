    ...
    <form class="flex flex-col gap-4" @submit.prevent="submit">
        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
            <div class="flex flex-col gap-4 lg:col-span-8">
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    <div class="text-sm font-semibold text-slate-900">Upload Details</div>
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        ...
                        <div class="sm:col-span-2 lg:col-span-3">
                            ...
                            <input
                                ...
                                class="mt-1 block h-9 w-full rounded-lg border border-slate-300 bg-white px-3 py-2 text-sm shadow-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100"
                                @change="onPickFile"
                                required
                            />
            ...
            <div class="flex flex-col gap-4 lg:col-span-4">
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-2 text-sm text-slate-600">Select filters and upload the Excel/CSV file, then submit to verify registration numbers.</div>
                </div>
