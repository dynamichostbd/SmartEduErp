        ...
        <div class="rounded-2xl border border-slate-200 bg-white p-5">
            <div class="grid grid-cols-1 gap-4 md:grid-cols-2 xl:grid-cols-3">
                ...
                <div>
                    ...
                    <select v-model="form.department_id" class="mt-1 h-10 w-full rounded-lg border border-slate-200 bg-white px-3 text-sm" required>
                ...
                <div class="xl:col-span-2">
                    ...
                    <input
                        ...
                        class="mt-1 block h-10 w-full rounded-lg border border-slate-200 bg-white px-3 py-2 text-sm"
                        @change="onPickFile"
                        required
                    />
