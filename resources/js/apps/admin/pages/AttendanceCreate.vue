                    ...
                    <table class="min-w-full divide-y divide-slate-200 text-sm">
                        ...
                        <tbody class="divide-y divide-slate-200 bg-white">
                            <tr v-for="(row, idx) in students" :key="'std-' + String(row.student_id || row.id) + '-' + idx">
                                ...
                                <td class="px-3 py-2">
                                    <div class="h-9 w-9 overflow-hidden rounded-lg border border-slate-200 bg-slate-50">
                                ...
                                <td class="px-3 py-2 text-center">
                                    <div class="inline-flex overflow-hidden rounded-lg border border-slate-200">
                                        <button type="button" class="px-3 py-1 text-xs font-semibold" :class="row.status === 'A' ? 'bg-slate-900 text-white' : 'bg-white text-slate-700 hover:bg-slate-50'" @click="setStatus(idx, 'A')">A</button>
                                        <button type="button" class="px-3 py-1 text-xs font-semibold" :class="row.status === 'P' ? 'bg-emerald-600 text-white' : 'bg-white text-slate-700 hover:bg-slate-50'" @click="setStatus(idx, 'P')">P</button>
                                    </div>
                                </td>
                            </tr>
