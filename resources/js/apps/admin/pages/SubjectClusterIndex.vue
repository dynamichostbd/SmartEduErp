                ...
                <table class="min-w-full border-collapse border border-slate-300">
                    <thead class="bg-emerald-100">
                        <tr class="text-left text-xs font-semibold uppercase tracking-wider text-slate-700">
                            ...
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Academic Level</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Department</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Name (en)</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Name (bn)</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2">Subjects</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">Min. Select</th>
                            <th class="border border-slate-300 bg-emerald-100 px-1 py-2 text-center">Fixed</th>
                    ...
                    <tbody>
                        ...
                        <tr v-for="(row, idx) in rows" v-else :key="row.id" class="text-sm text-slate-800" :class="idx % 2 === 0 ? 'bg-white' : 'bg-slate-50'">
                            ...
                            <td class="border border-slate-300 px-1 py-1">{{ row.name_bn || '—' }}</td>
                            <td class="border border-slate-300 px-1 py-1">
                                <div class="max-w-[480px] whitespace-normal">
                                    {{ subjectsText(row.subjects_json) || '—' }}
                                </div>
                            </td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ row.minimum_select ?? '—' }}</td>
                            <td class="border border-slate-300 px-1 py-1 text-center">{{ Number(row.fixed_subject || 0) === 1 ? 'Yes' : 'No' }}</td>
