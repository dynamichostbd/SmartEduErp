        ...
        <div class="grid grid-cols-1 gap-4 lg:grid-cols-12">
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        <div>
                            ...
                            <select v-model="form.academic_session_id" class="mt-1 h-9 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm shadow-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100">
                        ...
                        <div>
                            ...
                            <select v-model="form.academic_class_id" class="mt-1 h-9 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm shadow-sm outline-none focus:border-emerald-500 focus:ring-2 focus:ring-emerald-100">
                ...
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
                        <div class="sm:col-span-2 lg:col-span-3">
                            <div class="text-xs font-semibold text-slate-600">Student</div>
                            <select
                        ...
                        <div class="sm:col-span-2 lg:col-span-2">
                            <div class="text-xs font-semibold text-slate-600">Payment Type</div>
                            <select
            ...
            <div class="flex flex-col gap-4 lg:col-span-4">
                <div class="rounded-xl border border-slate-200 bg-white p-5 shadow-sm">
                    ...
                    <div class="mt-2 text-sm text-slate-600">Pending</div>
                </div>
