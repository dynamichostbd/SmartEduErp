        ...
        <div v-else class="grid grid-cols-1 gap-4 xl:grid-cols-12">
                ...
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.name" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Gender</div>
                            <select v-model="form.gender" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required>
                        ...
                        <div>
                            ...
                            <input v-model="form.dob" type="date" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Religion</div>
                            <input v-model="form.religion" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">NID</div>
                            <input v-model="form.nid" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Blood Group</div>
                            <input v-model="form.blood_group" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Father's Name</div>
                            <input v-model="form.fathers_name" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Mother's Name</div>
                            <input v-model="form.mothers_name" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Mobile</div>
                            <input v-model="form.mobile" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Email</div>
                            <input v-model="form.email" type="email" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div class="md:col-span-2">
                            <div class="text-xs font-semibold text-slate-600">Address</div>
                            <input v-model="form.address" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div class="md:col-span-2">
                            <div class="text-xs font-semibold text-slate-600">Permanent Address</div>
                            <textarea v-model="form.permanent_address" rows="2" class="mt-1 w-full rounded-sm border border-slate-300 bg-white px-3 py-2 text-sm"></textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.admission_roll" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Registration No</div>
                            <input v-model="form.registration_no" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">SSC GPA</div>
                            <input v-model="form.ssc_gpa" type="number" step="0.01" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Student Type</div>
                            <select v-model="form.student_type" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm">
                                <option value="Regular">Regular</option>
                            </select>
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Session</div>
                            <select v-model="form.academic_session_id" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required>
                                <option value="">Select</option>
                        ...
                        <div>
                            ...
                            <select v-model="form.academic_qualification_id" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required>
                                <option value="">Select</option>
                        ...
                        <div>
                            ...
                            <select v-model="form.academic_class_id" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" required>
                                <option value="">Select</option>
                ...
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.guardian_type" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Guardian Name</div>
                            <input v-model="form.guardian_name" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Guardian Mobile</div>
                            <input v-model="form.guardian_mobile" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Guardian Relations</div>
                            <input v-model="form.guardian_relations" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                    </div>
                </div>
                ...
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div class="mt-4 grid grid-cols-1 gap-4 md:grid-cols-2">
                        <div>
                            ...
                            <input v-model="form.passing_year" type="number" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Nationality</div>
                            <input v-model="form.nationality" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Quota</div>
                            <input v-model="form.quota" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div>
                            <div class="text-xs font-semibold text-slate-600">Marital Status</div>
                            <input v-model="form.marital_status" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                        <div class="md:col-span-2">
                            <div class="text-xs font-semibold text-slate-600">Extra Curricular Activity</div>
                            <input v-model="form.extra_curricular_activity" type="text" class="mt-1 h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm" />
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="xl:col-span-4 flex flex-col gap-4">
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div class="mt-4">
                        <div v-if="form.profile" class="mb-3 overflow-hidden rounded-xl border border-slate-300">
                            <img :src="form.profile" alt="Profile" class="h-52 w-full object-cover" />
                        </div>
                        <input
                            type="file"
                            accept="image/*"
                            class="block w-full rounded-sm border border-slate-300 bg-white px-3 py-2 text-sm"
                ...
                <div class=" border border-slate-300 bg-white p-5">
                    ...
                    <div class="mt-3">
                        <select v-model="form.status" class="h-9 w-full rounded-sm border border-slate-300 bg-white px-3 text-sm">
