    ...
    <div class="flex flex-col gap-4">
        <div class="rounded-2xl border border-slate-200 bg-white p-5">
            <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
                <div>
                    <div class="text-xl font-semibold text-slate-900">Library Books Info</div>
                </div>
...
export default {
    ...
    methods: {
        ...
        async load(page = 1) {
            ...
            this.error = ''
            try {
                const res = await window.axios.get('/admin/libraryBooksInfo', {
                    params: {
                        page,
                ...
                this.error = e?.response?.data?.message || 'Failed to load library books info.'
            } finally {
                this.loading = false
            }
        },
