...
class DesignationController extends Controller
{
    ...
    {
        return Schema::hasTable('designations') ? 'designations' : null;
    }
    ...
    public function store(Request $request)
    {
        $table = $this->table();
        if (!$table) {
            return response()->json(['message' => 'Designation module not ready'], 422);
        }
    ...
    public function show(Request $request, $id)
    {
        ...
        return response()->json(['designation' => $row], 200);
    }
